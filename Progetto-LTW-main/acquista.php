...
<head>
    ...
    <link rel="stylesheet" media="screen and (min-width: 1231px)" href="css/PC_acquista.css">
    <link rel="stylesheet" media="screen and (min-width: 601px) and (max-width: 1230px)" href="css/Tablet_acquista.css">
    <link rel="stylesheet" media="screen and (max-width: 600px)" href="css/Smartphone_acquista.css">

    <link rel="icon" type="image/png" href="immagini/bws_logo.png">
	<link rel="shortcut icon" type="image/png" href="immagini/bws_logo.png">
    <title>Acquista - Bestway Streetwear</title>
</head>
    ...
    <?php
        ...
        if ($dbconn) {
            ...
            if($result) {
                echo '
                <div class="message">
                    <h3>Grazie per aver acquistato su Bestway Streetwear!</h3>
                    <h3>Torna alla <a href="home.html">Home</a></h3>
                    <img class="pc" src="immagini/acquista_pc.jpg" width=100%;">
                    <img class="tablet" src="immagini/acquista_tablet.jpg" width=100%;">
                    <img class="phone" src="immagini/acquista_phone.jpg" width=100%;">
                </div>';
            }
            else {
                echo '
                <div class="message">
                    <h3>Ops! l'. "'" . 'acquisto non è andato a buon fine.</h3>
                    <h4>Torna alla <a href="home.html">Home</a></h4>
                    <img class="pc" src="immagini/acquista_pc.jpg" width=100%;">
                    <img class="tablet" src="immagini/acquista_tablet.jpg" width=100%;">
                    <img class="phone" src="immagini/acquista_phone.jpg" width=100%;">
                </div>';
