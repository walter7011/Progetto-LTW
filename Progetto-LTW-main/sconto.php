...
<head>
    ...
    <link rel="stylesheet" media="screen and (min-width: 1231px)" href="css/PC_sconto.css">
    <link rel="stylesheet" media="screen and (min-width: 601px) and (max-width: 1230px)" href="css/Tablet_sconto.css">
    <link rel="stylesheet" media="screen and (max-width: 600px)" href="css/Smartphone_sconto.css">
    ...
    <title>Sconto - Bestway Streetwear</title>
</head>
<body>
    ...
    <img class="img_sconto_PC" src="immagini/prova3.jpg" alt="">

    <img class="img_sconto_Tablet" src="immagini/prova5.jpg" alt="">

    <img class="img_sconto_Smartphone" src="immagini/prova4_1.jpg" alt="">

    <br>

    <div class="ins_codice">
        <form action="" method="post">
            Inserisci il codice sconto <input type="text" name="codice" maxlength="25">
            <input type="submit" class="btn btn-dark btn-rounded" value="Invia">
        </form>
    </div>
    ...
    <?php
        ...
        if ($dbconn) {
            ...
            if ($codice == "BEST20WAY") {
                ...
                $q2 = "insert into sconto (utente, sconto) VALUES ($1,'s')";
                $data = pg_query_params($dbconn, $q2, array($utente));

                if ($data) {
                    echo '
                    <div class="messaggio">
                        Lo sconto è stato applicato. <a href="home.html">Vai alla home</a>
                    </div>';
